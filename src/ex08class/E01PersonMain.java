...
/*
 추상화(Abstracion): 현실세계의 사물을 클래스로 형상화하는것을 말한다.
 			Person클래스는 "사람"의 일반적인 속성을 클래스로 추상화한 것이다.
 			
 클래스 선언시 class예약어를 사용한다. 클래스명의 첫글자는 반드시 대문자를 사용해야 한다.
 또한 public접근지정자는 하나의 Java파일에 한번만 사용할 수 있다.
 public class명은 파일명과 동일해야 하기 때문이다.
 */
	class Person {
		/*
