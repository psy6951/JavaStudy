...
class FruitSeller3 {
	...
	/*
	 ...
	 하지만 생성자는 인스턴스 생성 시 딱 한번만 호출되고,
	 개발자가 마음대로 호출할 수 없으므로 한번이상 초기화되지 않음이 문법적으로 보장된다.
	...
	public FruitSeller3(int money, int appleNum, int price) {
		myMoney = money;
		numOfApple = appleNum;
		//이 부분을 삭제하면 에러 발생함. 상수는 반드시 초기화되어야 하기 때문.
		APPLE_PRICE =price;
	}
...
public class E06FruitSalesMain3 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 초기화까지 할 수 있다. 따라서 초기화 메서드는 사용하는 것보다 
		 간단한 코드로 작성할 수 있는 장점이 있다.
		 */
