...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 오렌지박스 인스턴스와 당도가 10인 오렌지 인스턴트 생성 후 저장
		 */
		...
		/*
		 ...
		 실행할 수 없는 코드가 된다. 즉 자료형에는 안전하다고 볼수 있다.
		 */
//		oBox1.store("당도가 20인 오렌지");
		...
		/*
		 Object를 기반으로 생성된 FruitBox는 구현에는 편리하나 코드 레벨에서 
		...
		/*
		 ...
		 예외가 발생한다. 즉 런타임 에러가 발생하므로 실행 전에는 오류를 예측하기 쉽지
		 않은 단점이 있다.
		 */
