...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		/*
		 실수자료형
		 -정수형보다는 실수형이 더 큰 자료형이다. 0과 1 사이에 무한히 많응ㄴ 실수가 존재하기 때문.
		 -따라서 long(정수형)과 float(실수형)을 연산하면 float의 결과가 나오게 된다.
		 */
		long long1 = 100;
		float float1 = 200;
		//실수형(float)으로 자동형변환된다.
		...
		/*
		 ...
		 방법1: float을 long으로 강제형변환 후 연산한다.
		...
		/*
		 ...
		 -소수점이 있는 데이터를 float에 대입하려면 접미사 F 또는 f를 붙여야 한다.
...
//		float f4 = 3.14; //에러발생
		...
		//접미사(F or f)를 통해 float형 자료임을 명시한다.(권장사항)
		float f5 = 3.14F;
		System.out.println("f5="+ f5);

		//float형끼리의 연산은 기본규칙을 따르므로 float가 된다.
		float f6 = f3+ f4;
		...
		/*
		 ...
		 이는 Java의 문제가 아닌 컴퓨터의 태생적인 문제이므로 정확한 계산을 위해서는 약간의 보정을 필요로 한다.
		 */
	}
