...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 이때 접미사(L 혹은 ㅣ)을 붙여서 int형 자료가 아닌 long형의 자료임을 컴파일러에게 알려줘야 한다.
		 이와 같이 할당을 위해 입력되는 숫자도 자료형을 기반으로 메모리에 로드되는데, 
		 이를 가리켜 리터럴(literal)이라고 한다.
		 */
