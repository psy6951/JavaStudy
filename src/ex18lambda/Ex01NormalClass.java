...
/*
이와 같이 추상클래스를 아래에 있는 인터페이스로 변경가능하다
...
/*
 추상메서드를 포함한 인터페이스를 구현하면 하위 클래스에서는 반드시 오버라이딩 
 해야한다. 추상메서드를 포함한 클래스는 반드시 abstract로 선언하거나, 
...
public class Ex01NormalClass {
	...
	public static void main(String[] args) {
		/*
		 ...
		 인터페이스, 상속, 오버라이딩, 인스턴스 생성까지의 
		 과정을 거쳐야 하므로 너무 복잡하다.
		 
		 여기서는 부모타입의 참조변수를 통해 인스턴스를 생성한 후 
		 오버라이딩 된 자식쪽의 메서드를 호출하고 있다.
		 */
