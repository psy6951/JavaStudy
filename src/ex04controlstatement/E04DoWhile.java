...
/*
 do~while문
 : 반드시 한번은 실행해야 할 경우 사용해야 하는 반복문으로 조건검사없이 무조건 한번은 실행된다.
 형식]
 	반복을 위한 변수;
 	do {
 		실행문;
...
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		 시나리오] E03예제의 1~10까지 더하는 수열문제를 do~while문으로 변경하여 구현하시오.
		 */
		...
		/*/
		 시나리오] 1~1000까지의 정수중 4의 배수이거나 7의 배수인 수의 합을 구하여 출력하는 프로그램을 작성하시오.
