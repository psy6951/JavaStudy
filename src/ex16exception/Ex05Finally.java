...
/*
 ...
 기술하는 블럭이다. 단, 필수사항은 아니므로 꼭 필요한 경우에만 사용하면 된다.
...
public class Ex05Finally {
	/*
	 런타임 예외가 발생하는 메서드로 예외가 발생하면 ㄴ호출한 지점으로 
	...
	public static void main(String[] args) {
		/*
		 ...
		 하는 것은 가능하나, 반드시 예외처리해야만 프로그램이 종료되지 않는다.
		 즉 예외 인스턴스에 따라 무시할 수도 있는것도 있지만, 
		 이처럼 반드시 예외처리를 애야하는 것도 존재한다.
		 */
		try {
			runtime();
		}
		...
		/*
		 프로그램 내에서 예외가 발생했지만 예외처리를 통해 실행의 흐름이 끝까지
		 이어지므로 해당 문장이 실행된다. 
