...
public class Ex02PreDefineException1 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 예외가 발생하면 JVM(자바가상머신)은 해당 예외에 관련된 인스턴스를 만들어서
		 프로그램쪽으로 전달(throw)한다. 
		 이때 catch절에서 예외 인스턴스를 잡아주는 것을 "예외처리"라고 한다.
		...
		try {
			...
			/*
			 예외가 발생하는 지점. 해당코드가 실행될때 예외가 발생하여 
			...
			/*
			 ...
			 그러면 예외가 발생해도 프로그램의 실행은 유지된다.
			 */
			//예외 메시지1: 개발자가 임의로 메세지를 출력한다.
			System.out.println("예외가 발생했어요");
			//예외 메시지2: 간략한 설명을 출력한다.
			System.out.println("예외메세지:"+e.getMessage());
			//예외 메시지3: 예외에 대한 디테일한 설명을 출력한다. 가장 많이 사용.
			e.printStackTrace();
		}
		
		/*
		 예외처리를 통해 실행의 흐름이 중단되지 않으면 아래 문장은 정상적으로 출력된다.
		 즉 예외처리의 목적은 비정상적으로 중단되지 않도록 하는데 있다.
		 */
