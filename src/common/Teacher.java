...
public class Teacher extends Person{
	...
	/*
	 ...
	 따라서 서로 다른 인스턴스라면 다른 해시값을 가진다.
	 정수형 멤버변수는 그냥 사용하면 되고, 
	 인스턴스형 변수는 hashCode()를 통해 정수값으로 반환되는 해시값을 사용하면 된다.
	 */
	@Override
	public int hashCode() {
		/*
...
//		System.out.println("returnCode1="+returnCode1);
		...
		/*
		 방법2: 방법1이 번거롭다면 Objects 클래스의 정적메서드인 hash()를 사용해도 된다.
		 멤버변수의 개수만큼 인수로 전달하면 위와 동일하게 고유한 주소값을 정수형으로 반환해줌.
		 */
	...
	/*
	 ...
	 값이 같을때는 true 다를때는 false를 반환하도록 오버라이딩하면 된다.
	 */
	@Override
