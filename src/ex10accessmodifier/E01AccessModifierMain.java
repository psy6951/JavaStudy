...
/*
 이 클래스는 sub패키지에 정의되었으므로 
 사용을 위해서는 반드시 import 해야 한다.
 */
...
//		one.privateMethod();
		...
		/*
		 ...
		 import 선언시 접근할 수 있는 것은 public이고, 
		 private과 default는 접근할 수 없다.
		 */
