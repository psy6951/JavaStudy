...
/*
 ...
 이러한 불편함 때문에 함수형 프로그래밍(Functional Programming)의 
 장점이 대두되었고, 이런 Java의 단점을 보완하기 위해 
 JDK1.8부터 람다식을 지원하게 되었다.
 */
...
public class Ex03Lambda {
	...
	public static void main(String[] args) {
		/*
		 2번 예제의 익명클래스를 다음과 같은 람다식응로 표현할 수 있다.
		...
		/*
		위의 람다식을 한번 더 줄이면 다음과 같이 표현할 수 있다.
		ISchool3 인터페이스의 추상메서드를 통해 매개변수의 타입을 유추할 수 있으므로 
		String을 제거 가능하다. 또한 실행문이 하나인 경우에는 중괄호도 생략 가능하다.
		 */
