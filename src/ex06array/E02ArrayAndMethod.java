...
public class E02ArrayAndMethod {
	...
	public static void main(String[] args) {
		...
		/*
		 배열을 선언과 동시에 초기화한다. 초기값의 개수를 통해 크기가 결정된다.
		 생성된 배열 인스턴스의 주소값을 int형 배열병수인 arr에 할당하게 된다.
		 */
		int[] arr = {1,2,3,4,5};
		...
		/*
		 ...
		 즉 배열명은 배열에 저장된 값 자체가 아닌 Heap영역에 생성된 메모리의 
		 주소값을 저장하게 된다.
		 */
		...
		/*
		 ...
		 결구 동일한 배열을 참조하게 되어 아래 출력문에서는 동일한 결과가 2번 출력된다.
		 */
