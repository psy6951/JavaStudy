...
public class E05Date {
	...
	/*
	 Calendar 클래스를 통해 얻은 인스턴스르 초로 변환한 후 
	...
	public static void main(String[] args) {
		...
		/*
		 2024년 크리스마스까지 남은 날짜를 계산한다.
		 여기서는 두가지 서식의 날자를 파싱하여 구한 날짜 인스턴스를 통해 계산한다.
		 */
		//오늘날짜: 0000-00-00 형식
	...
	public static long myDiffDate(String today,String future) {
		...
		try {
			/*
			 ...
			 따라서 각 날짜의 서식을 명확히 지정해야 날짜를 인식하여 연산할 수 있다.
...
//			System.out.println(formatToday+ " " +formatFuture);
			...
			/*
			 ...
			 즉 100으로 나눠서 뒤의 3자리르 제거하면 순수한 '초'가 된다.
