...
/*
 ...
 -인스턴스간의 내용 비교를 위해서는 equals()를 각 클래스에 맞게 오버라이딩하여 사용해야 한다.
 -String과 같은 기본클래스는 별도의 오버라이딩 없이 내용비교 가능하다.
 */
class IntNumber{
	int num;
...
public class E04Object2MyEquals {
	...
	public static void main(String[] args) {
		/*
		 String과 같은 기본클래스는 별도의 오버라이딩 없이도 내용비교 가능하다.
		 */
		...
		if(num1.myEquals(num2)) {
			System.out.println("num1과 num2은 동일한 정수");
		}
		else {
			System.out.println("num1과 num2은 다른 정수");//결과출력
		}	
		/*
