...
/*
 해당 인터페이스의 접근지정자는 default이므로 
 해당 패키지를 벗어나면 사용불가.
 프로젝트 전체에서 사용하려면 
 별도의 파일로 생성하여 public으로 만들어야 한다.
 */
//interface Game {
...
public class E04InterfaceConstant {
	...
	public static void main(String[] args) {
		...
		System.out.println("가뮈(1) 바위(2) 보(3) 게임입니다.");
		...
		{
		/*
		 가위,바위,보를 1,2,3으로 설정했으나,
		 설정값이 많은 경우 모두 기억하기 어려우므로
		 명시적인 단어를 통한 상수를 사용하면 코드의 가독성이 노파진다.
		 */
		case Game.SCISSORS:
